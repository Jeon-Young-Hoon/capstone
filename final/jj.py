...
def webcam_control(file_name):
        ...
        output = cv2.VideoWriter(video_data_path+filename+".avi",fourcc,20.0,(1920,1080))
	...
	#feature init
        ...
        while webcam.isOpened():
                ...
                if start:
                   cv2.imwrite(video_data_path+filename+".jpg",frame)
                   
                #print frame.shape
                #copy_frame=frame.copy()
                copy_frame=cv2.resize(frame,(1920,1080))#,interpolation=cv2.INTER_AREA)
